...
--Q.5 write a SQL query to findall to find all transactions where the total_sale is greater than 1000
...
--Q.10	write a SQL query to create shift and number of order (Example Morning <=12,Afternoon Between 12& 17,Evening >17)
WITH hourly_sale
AS
( 
SELECT *,
